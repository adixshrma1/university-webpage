...
const Navbar = () => {
  ...
  return (
    <>
        <div className={`w-full text-white fixed top-0 left-0 z-10 p-2 md:p-4 lg:p-0 flex items-center justify-between lg:px-32 transition duration-500 ${sticky ? "bg-[#212ea0]": ""}`}>
            <img src={logo} alt="logo" className='w-32 md:w-40 lg:w-44' />
